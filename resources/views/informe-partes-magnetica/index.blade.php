                            ...
                            <tr>
                                ...
                                <td>
                                    <form
                                        ...
                                        {{-- <a class="btn btn-sm btn-primary " href="{{ route('informe-partes-magneticas.show',$informePartesMagnetica->id) }}"><i
                                        ...
                                        <a class="btn btn-sm btn-success"
                                            href="{{ route('informe-partes-magneticas.edit', $informePartesMagnetica->id) }}"><i
                                                class="{{ App\Models\User::find(Auth::user()->id)->getRol()=="ADMINISTRADOR" ? "fa fa-fw fa-edit" : "fa fa-fw fa-eye" }}"></i>
                                        </a>
                                        @csrf
                                        {{-- @method('DELETE') --}}
