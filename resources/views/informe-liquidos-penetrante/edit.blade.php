            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Datos Liquidos Penetrante</span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="general" role="tabpanel"
                                ...
                                <form method="POST"
                                    action="{{ route('informe-liquidos-penetrante.update', $liquidosPenetrante->id) }}"
                            ...
                            <div class="tab-pane fade" id="juntas" role="tabpanel" aria-labelledby="juntas-tab">
                                ...
                                <input type="hidden" name="inf_liq_penetran_id" id="inf_liq_penetran_id"
                                    value="{{ $liquidosPenetrante->id }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="display: none">
                    ...
                    {{ $juntasInformeLiquidosPenetrante = new App\Models\JuntasInformeLiquidosPenetrante() }}
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="hidden" name="junta_liq_penetran_id" id="junta_liq_penetran_id">
...
@section('scripts')
    <script src="{{ asset('js/cruds/juntas_informe_liquidos_penetrante.js') }}"></script>


    {{-- Script para las imagenes --}}
    <script type="text/javascript">
        var txtJuntaLiqPenetranteId = document.querySelector("#junta_liq_penetran_id");

        function mostrarModalImagenes(junta_liq_penetran_id) {
            txtJuntaLiqPenetranteId.value = junta_liq_penetran_id;
            cargarImagenes();
        }
        ...
        function cargarImagenes() {
            ...
            var currentUrl = "{{ url('juntas-liquidos-penetrantes-imagenes/api_getByIdJunta') }}" + "/" +
                txtJuntaLiqPenetranteId.value;
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    for (let i = 0; i < res.length; i++) {
                        ...
                        img += '<span  style="cursor: pointer;color: #ff331c;"  onclick="' + delefile + '">Eliminar</span></div>';
                    }
        ...
        function eliminarImagen(id) {
            var currentUrl = "{{ url('juntas-liquidos-penetrantes-imagenes/api_delete') }}" + "/" +id;
        ...
        $(document).ready(function(e) {
            ...
            $('#laravel-ajax-file-upload').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ url('juntas-liquidos-penetrantes-imagenes/api_add') }}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
