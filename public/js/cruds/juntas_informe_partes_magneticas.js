...
txtIdInfPartMagneticas = $('#id_inf_part_magneticas');
...
modalJuntasPartesMagneticas = $('#modal-juntas');

//variables de configuracion
// var nombreControlador = "juntas-informe-partes-magneticas";
// var appDir = window.location.pathname.split('/')[1];

var currentUrl = window.location.pathname.replace("informe-partes-magneticas", "juntas-informe-partes-magneticas");
...
function getByInfParticulaMagneticaId() {
    var IdInfPartMagneticas = txtIdInfPartMagneticas.val();

    $.ajax({
        //url: "/" + appDir + "/public/" + nombreControlador + "/api_getByInfParticulaMagnetica/" + IdInfPartMagneticas,
        url: currentUrl + "/api_getByInfParticulaMagnetica/" + IdInfPartMagneticas,
        type: "GET",
...
function add() {
    ...
    $.ajax({
        ...
        success: function (result) {
            getByInfParticulaMagneticaId();
            clearForm();
            modalJuntasPartesMagneticas.modal("toggle");
        },
        error: function (errormessage) {
            console.log(errormessage.responseText);
        }
...
function getFormData() {
    var dataObj = {
        id: txtIdJuntas.val(),
        inf_part_magneticas_id: txtIdInfPartMagneticas.val(),
...
function loadFormData(data) {
    ...
    txtIdInfPartMagneticas.val(data.inf_part_magneticas_id);
